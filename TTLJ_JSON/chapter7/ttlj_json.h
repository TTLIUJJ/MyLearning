...
void lept_stringify_value(lept_context&, const Lept_value&);
void lept_stringify_string(lept_context&, const Lept_value&);
void lept_stringify_array(lept_context&, const Lept_value&);
void lept_stringify_object(lept_context&, const Lept_value&);
#endif 
